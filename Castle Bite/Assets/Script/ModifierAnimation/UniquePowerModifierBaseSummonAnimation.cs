...
[CreateAssetMenu(menuName = "Config/Unit/UniquePowerModifiers/Animations/Summon")]
public class UniquePowerModifierBaseSummonAnimation : UniquePowerModifierAnimation
{
    [SerializeField]
    ...
    public override void Run(System.Object context)
    {
        ...
        if (context is BattleContext)
        {
            Debug.Log("Run Summon Animation");
