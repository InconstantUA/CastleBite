...
[CreateAssetMenu(menuName = "Config/Unit/UniquePowerModifiers/Animations/Damage")]
public class UniquePowerModifierBaseDamageAnimation : UniquePowerModifierAnimation
{
    [SerializeField]
    ...
    public override void Run(System.Object context)
    {
        ...
        if (context is BattleContext)
        {
            Debug.Log("Run Damage Animation");
