...
public class HireUnitCloseButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    Text txt;
    Button btn;
    Color tmpColor;
    ...
    void ActOnClick()
    {
        ...
        // we need to do it in this special way
        // because there are additional clean up actions should be taken
        // like delete hire unit selection panel, because it might change.
